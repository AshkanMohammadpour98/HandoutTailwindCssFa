...
- فصل سوم 
  ...
  - قسمت هفدهم [یوتیلیتی white space برای مدیریت](#یوتیلیتی_white_space_برای_مدیریت)
  - قسمت هجدهم [یوتیلیتی Word Break برای کنترول شکستن کلمات طولانی](#یوتیلیتی-Word-Break-برای-کنترول-شکستن-کلمات-طولانی)
  - قسمت نوزدهم [یوتیلیتی-Background-Color](#یوتیلیتی-Background-Color)
...
> # یوتیلیتی white space برای مدیریت


با این یوتیلیتی میتونیم فواصل و شکستن  این فواصل رو توی تلویند برای متن هامون مدیریت کنیم. همونطور که میدونین توی css هم پراپرتی white scpace رو برای این موضوع داریم .

 داکیومیشن سایت تلویند رو باز میکنیم مسیر doc و Typegrophe و Whitespase 
https://tailwindcss.com/docs/whitespace

تو این مسیر تلویند یوتیلیتی های مربوطه رو توضیح داده  که میبینیم مجموعن 6تا هستند



| class      | properties |
| ----------- | ----------- |
| whitespace-normal  ,  whitespace-nowrap  | white-space: normal;  , white-space: nowrap; |
...
و همین 6تا هستند و مقادیر دیگه ای رو نداره بنابراین روش Arbitrary  و شخصی سازی کردن یا تغیر دادنش رو توی فایل کانفیگ تلویند رو نداریم.


<div align="center">
  <img  src="./img/whiteSpace test text.PNG">
</div>

فرض کنیند که ما یه همچین متنی داریم که اسپیس و فاصله ها رو توی متنمون داریم به همین شکل


<div align="center">
  <img  src="./img/whiteSpace-normal.PNG">
</div>

اما توی خروجی مون پشت هم و خوانا نوشته شده میبینید و همه فواصل ازش حذف میشه  و اگه متنمون طولانی باشه  خط رو میشکنه میره سطر بعدی  تا اسکرول افقی نگیره بصورت خودکار  این

<b>عمل بخاطر اینه که پراپرتی white space normal است بصورت پیشفرض</b>

### یوتیلیتی whitespace-nowrap چیکار میکنه ؟
متن ما به هیچ عنوان نمیشکنه  یعنی همیشه فقط توی یه خط نوشته میشه و الباقیش هلا بصورت اسکرول خوردن میشه یا اگه overflow hidden داده باشیم کات میشه  کلا جلوی شکسته شدن متن به پایین رو میگیره و همه رو تو یه خط نشون میده  برای جاهایی که الزامن نیاز دارین که متنتون تو یه خط نمایش داده بشه فارغ از طولش  میتونین از whitespace-nowrap استفاده کنین. البته استفاده از یوتیلیی های دیگه مثل line-calmp-1  یا truncate که قبلا برسی کردیم و باعت اسکرول افقی هم نمیشد منطقی تره این جور جاها ولی خب اگه با اسکرول افقیش مشکلی نداشتین و بهردلیلی میتونین از این whitespace-nowrap هم استفاده کنید.

<div align="center">
  <img  src="./img/whiteSpace-noWrap.PNG">
</div>

### یوتیلیتی بعدی که برای whitespace  ها داریم مقدار whitespace-pre است؟
زمانی که از این یوتیلیتی استفاده میکنیم تمامی اسپیس ها و فواصلی که تو متن مون موقع نوشتن دادیم رو مثل خودش اعمال میکنه و اگه طولانی هم بود اسکرول میخوره که بتونه همه رو نمایش بده  دقیقن همونطور که نوشتیم نمایش میده و اگه یه متن طولانی رو توی کد مون نوشته باشیم تو یه خط همون طوری تو یه خط تو خروجی هم هست شکسته نمیشه و اسکرول ایجاد میکنه.  اگر که خاستین متن هاتون به همون صورت که نوشتین تو کداتون باشه با همون فاصله و اسپیس ها و همون طور که نوشتین از جایی بصورت اتوماتیک نشکنه بره سطر بعدی  ... میتونین از این whitespase-pre  استفاده کنین.

<div align="center">
  <img  src="./img/whiteSpace-pre.PNG">
</div>

یوتلیتی بعدی whitespace-pre-line است چیکار میکنه ؟
صرفن اون اینتر ها و لاین بریک های که زدین توی متنتون  اعمال میشه و دیگه اون فواصل اضافی رو خودش اتومات حذف میکنه و جایی اگه متنتون طولانی بود شکسته میشه مثل شیوه نورمال 
پس زمانی اگر خاستین فقط اون لاین بریک هاتون یاهمون اینتر هایی که زدین اعمال بشه و خط متن هاتون بصورت نورمال بشکنه وباعث اسکرول عمودی نشه و فواصل رو حذف کنه میتونین از این whitespace-pre-line استفاده کنین.


<div align="center">
  <img  src="./img/whiteSpace-pre-line.PNG">
</div>

### یوتیلیتی بعدی که خیلی به درد میخوره whitespace-pre-werap هست هالا اون چیکار میکنه؟
فواصل اضافی رو که نوشتیم رو همونطور که گزاشتیم میمونه اسپیس ها و لاین بریک یا همون اینترهایی که زدیم مونده و متن طولانی که جاش نمیشه رومیشکنه بره سطر بعدی  

<div align="center">
  <img  src="./img/whiteSpace-pre-wrap.PNG">
</div>

### یوتیلیتی Whitespace-break-spaces  چیه و چیکار میکنه ؟
عمملکردش مثل whitespace-pre-wrap است با این تفاوت اگه ما انتهای متن که میشکنه  اسپیس فاصله داشته باشیم اون فاصله رو میبره سطر بعدی  ابتدای خط بعدی  اما تو whitespace-pre-wrap اگه یه همچین اتفاقی بیفته یعنی فاصله یا چند اسپیس فاصله داشته باشیم موقع شکسته شدن متن اونا رو یکی میکرد و حذف میکرد که فاصله نیفته به اول سطر بعدی .

```یه نکته خیلی جاها این ریزه کاریا تو متن ها میبینیم فواصل رو مخصوصن توسایز های کوچک مثل موبایل که متن ها فاصله ها و اسپیس هایی دارند و.... این بخش ها رو اگه لازم شد چندین بار مرور و تمیرین کنین که با یه پراپرتی یا یوتیلیتی خیلی کوچک و ساده حل میشه ومیشه مدیریت کرد```

<div align="center">
  <img  src="./img/whiteSpace-break-spaces.PNG">
</div>

---

> # یوتیلیتی Word Break برای کنترول شکستن کلمات طولانی


یوتیلیتی که بما این امکان رو میده شکستن کلمات طولانی خودمون  رو توی متن مدیریت کنیم هالا جلوتر متوجه میشید نکته ای که هست این یوتیلیتی تو تلونید یه یوتیلتی ترکیبی است یعنی از ترکیت دوتا پراپرتی css  
 
یه کلمه طولانی رو در نظر بگیرین که همه شون بهم چسپیدن و بصورت اتومات هم  چون اسپیسی بینشون نیست و همه اون کلمات بهم چسپیدن نمیدونه از کجا فاصله هست و بشکنه بندازه سطر بعدی و اسکرول افیقی میفته تو صفحه



<div align="center">
  <img  src="./img/word Break test text.PNG">
</div>


یه کلمه طولانی رو در نظر بگیرین که همه شون بهم چسپیدن و بصورت اتومات هم  چون اسپیسی بینشون نیست و همه اون کلمات بهم چسپیدن نمیدونه از کجا فاصله هست و بشکنه بندازه سطر بعدی و اسکرول افیقی میفته تو صفحه
وارد داکیومیشن خود تلویند میشیم  مسیر Doc و Typegraphe و نوشته word Break 
...
همونطور که میبینید یوتیلیتی های مربوط به word Brake همین چهار تا هستند 

همین چند تا هستن و خود تلویند ساخته و قابلیت تغیر و شخصی سازی تو فایل کانفیگ تلونید  یا استفاده از روش Arbitrary رو نداره

یوتیلیتی break-normal:
بصورت پیشفرض است همون حالت دیفالت هستش با قرار دادنش تغیری نمیکنه 

یوتیلیتی break-words:
زمانی که اونو به یک متن اعمال میکنیم کلمات طولانی ما بصورت خودکار میشکنند  و از اسکرول افقی جلوگیری میکند ```من پیشنهاد میکنم این یوتیلیتی رو حتما به متن ها تون بدید که اگه کلمه ی طولانی بدون وایت اسپیس فاصله بود بشکنه بره سطر بعدی اگه جا نداشت تا باعث اسکرول افقی نشه.``` 

<div align="center">
  <img  src="./img/word Break break-words.PNG">
</div>

یوتیلیتی  break-all:
این یوتیلیتی خیلی به دردمون نمیخوره درسته از اسکرول افقی هم جلوگیری میکنه اما چون از هرجا عشقش کشید کمه رو میبره  هیچ تلاشی نمیکنه تا حد اقل کمات رو نگه داره مثلا ممکنه یه حرف کلمه تو سطر بالا باشه و سه حرفش بیاد سطر پایین



یوتیلیتی break-ceep : 
این یوتیلیتی به درد زبان های فارسی و انگیسی نمیخوره و برای زبانهای چینی و ژاپنی و کره ای هست و خب میاد از شکسته شدن کلمات  و عبارات ژاپنی  جلو گیری میکنه  اگر احیانن  داشتین سایتی میزدید  که توش از عبارت چینی  ژاپنی و کره ای استفاده میشد   و میخواستین کلمات طولانی و بدون وایست اسپیس اسکرول افقی ایجاد نکنه  از این پراپرتی استفاده کنین.
	 
---

> # یوتیلیتی Background Color

قبلا با رنگ ها کار کردیم و چندین بار برای مثال ها از یوتیلیتی background color استفاده کردیم و بهاش تا حدودی اشنا هستیم و خیلیی روش مانور نمیدیم .
وارد داکیومیشن خود تلویند میشیم وارد مسیر Doc و وارد بخش Backgrounds میشیم 
https://tailwindcss.com/docs/background-color

یوتیلیتی های خیلی زیاد و متنوعی داره که میتونین وارد داکیومیشنش بشین و بخونین همه رو 


<div align="center">
  <img  src="./img/backgroundColor utilites class.PNG">
</div>

سینتکسش اینطوریه که  کلمه bg- و اسم رنگ و اگه خاستیم میتونیم طیف رنگیشم بنویسیم.
یا اون رنگایی یا پالت های رنگی که خودمون تو فایل کانفیگی درست کردیمم میتونیم اسفتاده کنیم.
یه نکته بعد تعریف بکگراند رنگ میتونیم پیوسته مقدارشفافیت یا opacity رو هم با بکگراندش و اون طیف رنگیش اسفتاده کنیم 


<div align="center">
  <img  src="./img/backgroundColor Arbitrary.PNG">
</div>

علاوه براینا میتونیم برای یوتیلیتی بکگراند رنگ  بجای نوشتن اسم رنگی کلمه bg- و بصورت Arbitrary بهش مقدار بدیم
...
یعنی بیاییم به عنوان background image خودمون  یه url رو اختصاص بدیم که این url  یک تصویر تصویری رو به  بکگراند عنصر ما اضافه کنه خیلی جاها ممکنه به درد مون بخوره .
طبق معمول وارد داکیومیشین تلویند میشیم قسمت Doc و بخش Background و روی Background Image میزنیم (یکم میاییم پایین دقت کنین که هم بکگراند بصورت عکس موردنظرمون رو داریم هم بکگراند بصورت گرادینت که بعد ها بهاش اشنا میشیم)
https://tailwindcss.com/docs/background-image

بصورت عمده ما تصاویر مربوط به بکگراند رو بصورت Arbitrary مینویسم به شکل زیر
...
به این صورت که میاییم کلمه bg- و []داخل اون کلمه  url ("adres image")
وتوش مسیر تصویر موردنظرمون رو قرار میدیم.
پس بصورت عمده بیشتر بکگراند عکس رو از طریق Arbitrary  به این شکل اعمال میشن که توی خود css هم به همین صورت است. 
ولی خب علاوه بر این حالت تلویند میاد قابلیت اضافه کردن اونا تو فایل کانفیگ تلویند  رو به ما میده که میتونه چند بار مصرف باشن و چند بار بتونیم از این تصاویر استفاده کنیم.

**خب اول بریم  بریم روش Arbitrary رو برای افزودن بکگراند تصویر به عناصر برسی کنیم**

```html
<body>

<div class="h-screen bg[url('/public/dist/images/image-1.jpg')]">
...
این یوتیلیتی h-screen رو در اینده یاد میگیریم فقط اینو بدونین که ما چون چیزی توی تگ div نزاشتیم که یه ارتفاعی بگیره و چیزی داخلش باشه که معلوم باشه که بکگراند بگیره دیگه بجای اینکه چیزی توش بزاریم یا بنویسم و بکگراند عکس بهش بدیم اومدیم ارتفاقش رو برابرا اسکرین کردیم یعنی این h-screen یعنی ارتفاع برابر 100vh کل ویو پورت اسکرین کاربر

<div align="center">
  <img  src="./img/bg-img one.PNG">
</div>

هلا بعضی وقتا پیش میاد که چند تا بکگراند عکس داریم یعنی برای یه عنصر چند تا background image داریم
یه , url('image addres')

```html
  <body>
    <div
      class="bg-[url('/public/dist/images/image-1.jpg'),url('/public/dist/images/image-2.jpg')] h-screen"
    ></div>
  </body>
```

فقط حواستون باشه که بینشون اصلا فاصله نزارین چون تلونید نمیتونه فاصله ها رو خوب تشخیص بده و منضور رو خوب نمیفهمه  و تو کامپایل کردن به مشکل میخوره و هیچ کدوم از تصاویر اعمال نمیشن 

<div align="center">
  <img  src="./img/bg-img one nad tow.PNG">
</div>

اینجا چون سایز تصویرا بزرگ تر از اسکرین است و دوتا هم هستن و ماهم ازتفاع اون تگ div رو برابر اسکرین گزاشتیم معلوم نیست تصویر دوم ولی انسپکت گرفتیم و مشخصه که هر دو تصویر اعمال شده.  جلوتر که یوتیلیتی مربوط به background size رویاد گرفتیم بهتر میتونیم روش کار کنیم.



هالا اگر احیانن خواستیم از این background image هامون یک مقدار ثابتی بسازیم  داخل فایل کانفیگ تلویند  بسازیم  کارمون خیلی ساده و روتینه مثل همیشه  وارد فایل کانفیگ تلویند میشیم و توی قسمت ابجیکت extend  اسم backroundImage و مینویسم و بصورت ابجیکت و یه اسمی براش میزاریم و ادرسشو جلوش به عنوان مقدار عنوانش مینویسیم 

<div align="center">
  <img  src="./img/bg-img costom config.PNG">
</div>

به همین شکل یا مثلا عنوانشو میتونیم بزاریم coverBg  و همون ادرس عکس که استفاده کرده بودیم بصورت arbitrary رو قرار میدیم حتی میتونیم دوتا عکس هم بزاریم هلا میتونیم برای بکگراند مون از این یوتیلیتی که ساختیم استفاده کنیم 
bg-coverBg این کلاس یوتیلیتی رو به هر عنصری بدیم قایل استفاده است و میتونیم این یوتیلیتی که ساختیم رو هرکجا که خاستیم برای هر عنصری بصورت بکگراند استفاده کنیم به این شکل که کلمه bg-اسم اون یوتیلیتی که ساختیم

هلا کدوم روش بهتره ؟ بستگی به نوع کاربردش داره اگه فقط یه بار خاستین برای یه عنصری بکگراند بدین بصورت یکبار مصرف باشه به روش  Arbitrary 

---

> # یوتیلیتی های مربوط به Background Size

توی بخش قبلی با background image اشنا شدیم و الان میخوایم با background size آشنا بشیم و  اون بکگراند عکس رو تنظیمش کنیم 

داکیومیشن خود تلویند رو داریم طبق روال به مسیر Doc  و قسمت Bacgrounds و Bacground Size
...
بصورت پیشفرض تلویند برای قضیه background size  سه تا یوتیلیتی  در اختیارمون قرار داده .

bg-auto :
bg-auto که بصورت پیشفرض هم هست که درواقع تصویر شما با سایز اصلیش به نمایش در میاره توی بکگراندمون هلا چه کوچیک هست تصویر چه بزرگ  با سایز اصلی خودش نشون داده میشه 

bg-cover :
 که بکگراند سایز رو درحالت کاور سایز اون عنصر درنظر میگیره زمانی که از این مقدار استفاده میکنیم خود css تصورمون رو اونقدر بزرگ و کوچیک میکنه که  کل اون عنصری که این رو به عنوان بکگراندش انتخاب کردیم  رو کامل پوشش بده  هالا ممکنه تصویر خیلی بزرگ تر از سایز عنصر باشه و مقداری از تصویر کات بشه یا خیلی کوچیک باشه و کش بیاد که همه عنصر رو بتونه در بر بگیره و پوشش بده .

bg-contain :
زمانی که بکگراند سایز یه عنصری رو برابر bg-contain درنظر بگیریم اون تصویر بدون اینکه کراپ بشه بصورت کامل به عنوان بکگراند عنصر شما درمیاد. یعنی ممکنه کوچیکتز از عنصرتون باشه  ولی تحت هیچ شرایطی کراپ نمیشه 

خب هلا بریم این سه تا یوتیلیتی رو تست کنیم  یه نکته بگم اینکه ما با repeat  ها که مربوط به تکرار هستنش در صورتی که تصویر از سایز عنصر کوچیکتر باشه در جلسات اینده اشنا میشیم ولی بخاطر درک بهتر و نمایش بهتر توی این مثال ها استفاده میکنیم که بعدن بیشتر درمودش توضیح میدیم.

```html
<body>
    <div
      class="h-screen
       bg-[url('/public/dist/images/image-1.jpg'),url('/public/dist/images/image-2.jpg')] 
       bg-no-repeat
       bg-auto"
    ></div>
  </body>
...
<div align="center">
  <img  src="./img/bg size bg-auto.PNG">
</div>

ما دوتا تصویر برای این بکگراند عنصرمون دادیم توی جلسه پیش هم همین رو دادیم اگه خاطرتون باشه و سایزش برابر 100vh کل ویو پورت بود که چون یوتیلیتی    bg-auto دادیم  که بصورت دیفالت هم هست تغیری نمیکنه.
...
<div align="center">
  <img  src="./img/bg size bg-cover.PNG">
</div>

اینجا که بکگراند سایزمون رو گفتیم یوتیلیتی  bg-cover و سایز عنصرمون هم برابر ویو پورت هست میاد به اندازه کل عنصر مون عکسو درمیاره و اضافه شو کات میکنه الان میبینیم که تصویر دوم و یه مقداریتصویر اول هم کات کرده که اندازه بشه با سایز عنصر 
...
<div align="center">
  <img  src="./img/bg size bg-continer.PNG">
</div>

توی این یوتیلیی bg-contain هم اومده که تصاویرمون که دوتا هست رو کنار هم قرار بده که یکی جاشده و دومی جانمیشده و سفید گزاشته .


این شد بکگراند سایز ها دیفالت خود تلویند ولی نکته ای که هست اینه که زمانی که ما از بکگراند سایز استفاده میکنیم مخصوصن زمانی که چندین تصویر کنار هم داریم برای بکگراند عنصرمون نیاز داریم که  این عکسای بکگراند سایز رو بصورت دقیق  هالا برحسب پیکسل یا درصد یامواردی از این قبیل تعین کنیم.
 پس درنتیجه این مقادیر دیفالت خود تلویند خیلی جاها ممکنه که کار مارو راه نندازه  اینجاست که مقادیر Arbitrary  بکگراند سایز و همچنین مقادیر  کانفیگی به دردمون میخورن  چطوری؟
فرض میکنیم که بکگراند سایز من برای تصویر اول عرضش برابر 50درصد صفحه باشه ازتفاعش هم اتوماتیک محاسبه بشه که نسبتا توش بهم نخوره  برای تصویر دوم که زیر تصویر اول بود میخوام عرضش برابر 100درصد صفحه باشه و ازتفاعشم اتوماتیک باشه که نسبت اون هم بهم نخوره 
  ...
  <body>
    <div
      class="h-screen
       bg-[url('/public/dist/images/image-1.jpg'),url('/public/dist/images/image-2.jpg')] 
       bg-no-repeat
       bg-[length:50%_auto,100%_auto]"
    ></div>
  </body>
```

```داخل []  کلمه length: رو مینویسم به همین صورت بصورت Arbitrary یه نکته مهم توی  فقط مقداردهی Arbitrary تلویند نمیتونه فاصله یا اسپیس رو بخونه هرکجا نیاز به اسپیس یا فاصله داشتیم از  _ اسفتاده میکنیم ```



ازهمین مقادیر توی فایل کانفیگ تلویند هم میتونیم یوتیلیتی هاشو بسازیم و چنیدن بار از همین مقدار ها اگه چندین جا خاستیم برای بکگراند سایز استفاده کنیم 


<div align="center">
  <img  src="./img/bg size  costom config.PNG">
</div>


`توی فایل کانفیگ چون داخل ابجکت خود backgrooundSize  هستیم خودش میفهمه منضورمون بکگراند سایز است و نیازی به نوشتن length نیست  و فقط توی روش Arbitrary هست که فاصله ها رو نمیتونه هندل کنه و نمیشناسه تو فایل کانفیگی فاصله میزاریم .`
به ترتیبی که تصاویر روداریم مثلا چند تاتصویر برای بکگراند داشته باشیم به همون ترتیب هم میتونیم سایزاشون رو مشخص کنیم یا اگه یک تصویرهم داشتیم میتونیم سایزشو به این دو روش تنظیم کنیم.


---

> # یوتیلیتی های مربوط به Backround Repeat

 وارد داکیومشین خود تلویند میشیم مسیر Doc  و Backrounds و بخش Background Repeade میشیم 
...
میبینیم که خود تلویند برای قضیه background repead 6تا یوتیلیتی گزاشته که هرکدوم ازاینها یه مقداری رو برای background repead  ثبت میکنند
که خب استفاده از Arbitrary  و تغیر کانفیگ براش وجود نداره چون در کل مقاریزش همین 6تا هستند و نیازی به شخصی سازی ندارند

bg-repead:
میاد پراپرتی background repeat رو برابر repead درنظر میگیره که بصورت دیفالت پیشفرض هم همین هست که اگه تصویر بکگراند از اون سایز عنصر کوچکتر باشه تا جایی که میشه پر کرد فضای خالی عنصر رو تصویر بکگراندی که گزاشتیم تکرار میشه  هم در طول و هم عرض فقط پرمیکنه و ممکنه تصاویری که هی تکرار میشه یه سریاش کات هم بشن



<div align="center">
  <img  src="./img/bg-repeat.PNG">
</div>

bg-no-repeat:
این یوتیلیتی از تکرار عکس بکگراند جلوگیری میکنه و صرفن یکدونه ازش هست  و با همون سایزی که هست چه بزرگ و چه کوچیک سایز خودش نمایش داده میشه که ما معمولا از این هم زیاد استفاده میکنیم چون میخایم خیلی وقتا از تکرار شدن بکگراند جلوگیری کنیم 

bg-repeat-x: , bg-repeat-y :
اگر از bg-repeat-x اسفتاده کنیم بگراند فقط در راستای عمودی تکرار میشه  و اگه از bg-repeat-y استفاده کنیم بکگراند مون فقط در راستای افقی تکرار میشه
bg-repeat-round:
درنگاه اول خیلی شبیه به مقدار دیفالت یعنیی bg-repeat است ولی اما اگه کمی بیشتر دقت کنیم دیگه تصاویری که تکرار میشن بریده و کات نمیشن  یعنی css  بیشترین مقداری که میتونند جابشن بصورت کامل رو میاد جامیده  و اون جاهای یکم خالی رو با استفاده از تصاویری که تکرار کرده تاجایی که میتونه یکم کش میده که بپوشونه همه فضای خالی رو 
...
> # ایجاد گرادینت ها در تلویند


قراره ایجاد گرادینت ها توی تلویند رو باهم برسی کنیم خود قضیه اضافه کردن گرادینت ها به عنوان background image  در تلویند زیاد قضیه پیچیده ای نیست یه سری یوتیلیتی براش داره که بهاشون اشنا میشیم . اما شخصی سازی کردن این گرادینت ها میتونه یه مقدار تو این جلسه پیچیده و وقت گیر باشه مطالب مهمی داریم دقت کنین 
`چون در خلال همین جلسه  یه سری از فیچر ها و قابلیت های کلیدی و مهم تلویند رو هم یادمیگیریم که  قطعا خیلی به درد میخوره ویدیو این قسمت برای درک بهتر حتما دیده شود یعنی نتنها توی همین قضیه گرادینت ها ازش استفاده میکنیم بلکه جاهای دیگه هم این فیچر به دردمون میخورن بنابراین این جلسه خیلی مهمه `


` گرادینت ها به سه بخش تقسیم میشه یکی مشخص کردن جهت گرادینت و دوم مشخص کردن رنگهای گرادینت و سوم میتونیم position رنگا روهم بصورت درصدی بهش بدیم 
و با مقادیر arbitrary تو این موضوع اشنا میشم  `



خب داکیومیشن تلویند رو باز میکنیم وارد Doc و تو بخش منوی Backgrounds  وارد Background Image میشیم 
...
میبینیم که سیستم کلی تلویند یوتیلیتی های مربوط به گرادینت تلویند به همین شکل است که درقدم اول  با استفاده از این 8تا یوتیلیتی  که برامون لیست کرده  هلا به غیر از bg-none که میاد background image  رو حذف میکنه زاویه و جهت گرادینت مون رو باید مشخص کنیم .
برای مثال اگه بییایم از یوتیلیتی گرادینت bg-gradient-to-t  اسفتاده کنیم background image  ما به جهت به سمت بالا یعنی از سمت پایین به بالا یا اگه از bg-gradient-to-tr   استفاده کنیم  از سمت پایین به سمت بالا و راست هدایت میشه و به همین ترتیب تو قدم اول میتونیم جهت گرادینت مون رو در قدم اول مشخص کنیم مثلا بگیم بالا به سمت راست یا چپ باشه یا پایین به سمت راست یا جپ باشه یا راست به چپ و ... باشه  که 8 تا از این یوتیلیتی ها رو برای ما گزاشته .

تو قدم دوم هالا وقتی که جهت linear-gradient گرادینت رو مشخص کردیم  لازمه رنگ های linear-gradient گرادینت مون رو مشخص کنیم یعنی اوکی جهتو مشخص کردیم به سمت بالا یا راست هالا از چه رنگی  به چه رنگی که برای انجام اینکار باید بریم سراغ یک یوتیلیتی دیگه که توی مسیر Doc و از منوی Backgrounds  و Background Color Stops 
https://tailwindcss.com/docs/gradient-color-stops

<div align="center">
  <img  src="./img/bg gradient color utilites.PNG">
</div>

که سینتکس کلیش ساده هست  برای مشخص کردن رنگ شروع یعنی رنگی که میخواید گرادینت تون ازش شروع بشه from- و اسم مورد نظر که هرنگی با هر طیفی که دوست دارین  که این اسامی رنگا از همون پالت های رنگی که تو همه یوتیلیتی های رنگ پزیر مشترکه  اینجام هست یا اگه رنگی خودتون تو فایل کانفیگ تعریف کرده باشین هم میتونین استفاده کنین مثلا  from-red-500  به همین شکل رنگ شروع بکگراند گرادینت رو انتخاب کنین


```html
<div class="h-screen bg-gradient-to-r from-red-500"></div>
```

و برای مشخص کردن رنگ پایان گرادینت  یعنی رنگی که میخوایید گرادینتتون با اون تموم بشه از مقدار to- و اسم رنگ 

```hrml
<div class="h-screen bg-gradient-to-r from-red-500 to-red-800"></div>
```


به همین شکل میتونیم رنگ شروع و پایان خودمون روتوی تلویند مشخص کنیم  اگه خاستیم وسط اینا رنگی نیاز داشتیم بینشون از مقدار via- زنگ مورد نظر

```html
<div class="h-screen bg-gradient-to-t via-blue-500 from-red-500 to-red-800"></div>
```

<div align="center">
  <img  src="./img/bg gradient use multe background color to-t .PNG">
</div>

همون طور که تو تصویر بالا میبینین ازسمت پایین با red-500 شروع شده و وسطش blue-500 و در انتها با red-500 تموم شده .

یه مثال دیگه هم بزنیم


```html
<div class=" h-screen bg-gradient-to-tr via-blue-500 from-red-500 to-red-800"></div>
```

<div align="center">
  <img  src="./img/bg gradient use multe background color to-tr.PNG">
</div>

میبینیم که از سمت پایین به tr سمت بالا و سمت راست هست.

یه مثال دیکه هم بزنیم 


```html
<div class="h-screen bg-gradient-to-r via-blue-500 from-red-500 to-red-800"></div>
```


<div align="center">
  <img  src="./img/bg gradient use multe background color to-r .PNG">
</div>


الان از سمت چپ به راست شده .
یه قضیه دیگه هم هست شما میتونین position مربوط به این رنگ ها رو هم تعین کنین چطوری؟ این موضوع رو توی css داریم با یه مقدار درصدی که تو تلویند هم داریم .  تلویند هم این امکان رومیده که مقادیرمون رو به همین شکل تعریف کنیم هالا چطوری؟
میتونیم مجددن از همون from , via , to  استفاده کنیم و درصد بزاریم 

و به همین شکل میتونیم پوزیشن یا جایگاه رنگامون رو مشخص کنیم 


<div align="center">
  <img  src="./img/bg gradient use multe background color position example preview.PNG">
</div>

مثلا بگیم رنگ from  شروع من از 10% شروع بشه  و ...
خب بریم یه تست کنیم ببینیم چطوریه 


```html
<div class"h-screen bg-gradient-to-r from-red-500 from-10% via-blue-500 via-40% to-red-950 to-50%"></div>
```


<div align="center">
  <img  src="./img/bg gradient use multe background color position 1.PNG">
</div>

هلا برای position هاشون میتونیم از مقادیر Arbitrary هم استفاده کنیم  هم برای رنگ های شروع وسط و رنگ انتها و هم پوزیشن هاش


<div align="center">
  <img  src="./img/bg gradient use multe background color position 2.PNG">
</div>

و باز هم میبینیم که خروجی به همون شکل هست .

`نکته دیگه که خاستیم برسی کنیم اینه که اگه احیانن خاستیم گرادینتی بسازیم که از یک سمت به سمت دیگه شفاف تر بشه یعنی اون رنگ اولشو بدیم و رنگ اتمامش شفاف باشه بشه رنگ پس زمیه اگه سفیده سفید باشه مثلا هر نگی پس زمینه هست  و بدون رنگ تموم بشه مثلا با رنگ قرمز شروع بشه و انتهاش بدون رنگ  تموم بشه `

برای اینکار کافیه که فقط مقدار شروع رنگ گرادینت مثلا  from-red-500   رو بدیم و دیگه نباید مقدار to رو به عنصر بدیم  فقط همین کافیقه
...
<div align="center">
  <img  src="./img/bg gradient background color tow color transparent.PNG">
</div>

`نکته بعدی که میخوایم بهش اشاره کنیم ساخت زوایای یا زاویه های جدید هست که حتی داکیومیشن تلویند هم درست وحسابی به این نکته اشاره نکرده `


هالا داستان چیه اگه خاطرتون باشه تلویند خودش 8 تا یوتیلیتی 8تا جهت مختلف برای گرادینت ها در اختیارمون داده برای مثال به سمت بالا و بالا وپایین وچپ وراست و از پایین به سمت راست وبالا و...  `ما همونطور که میدونین ما توی css  میتونیم برای گرادینت هامون  علاوه براین مقادیر نسبی راست و بالا و.. از مقادیر مطلق زاویه ای هم استفاده کنیم  مثلا 60 درجه 50 درجه  هلا تلویند خودش مستقیمن قابلیت شخصی سازی همجین موردی رو بهمون نمیده  که بیاییم زوایای جدیدی رو مشخص کنیم تو فایل کانفیگ تلویند `

پ

خب وارد فایل کانفیگ تلویند میشیم تو ابجیکت extebd  و چون مربوط به backgroundImage  هست  مینویسیم backgroundImage  بصورت ارایه اگه خاطرتون باشه برای عکس ها هم که بگراند درست میکردیم همینکارو میکردیم همین backgroundImage رو مینوشتیم  فرقی نمیکنه برای اضافه کردن url عکس یا گرادینت یا هرچیزی که مربوط به backgroundImage هست  ما ازش استفاده میکنیم کاری که میخوایم انجام بدیم میخوایم یه زاویه جدید برای گرادینت مون درست کنیم  به نحوی که این مقدار جدید ما که میخوایم درست کنیم باید با همون Color Stops های تلویند که برای رنگ شروع و وسط و اخر که انتخاب میکردیم باید سازگار باشه یعنی دباره بتونیم از from , vio , to و رنگشون استفاده کنیم
برای انجام اینکار میاییم یه دونه از اون مقادیری که خود تلویند ازش استفاده میکنه رو کپی میکنیم 



<div align="center">
  <img  src="./img/bg gradient direction angle utiletis.PNG">
</div>

اگه خاطرتون باشه اون 8 تایی بودن که خودش در اختیارمون گزاشته بود 
یه اسمی براش میزاریم تو فایل کانفیگ  مثلا gradient60 و اینو که کپی کردیم به عنوان مقدارش بهش میدیم و تغیرش میدیم جایی که میخوایم رو


<div align="center">
  <img  src="./img/bg gradient create new gradient position in config file.PNG">
</div>

این قسمت دوم رو نگه میداریم این قسمت چیه هالا؟ تلویند اون color stops ها رو اینجا ذخیره میکنه یعنی درواقع اون کالر پوزیشن های گرادینت رو تو این متغیر میریزه برای گرادینت ها بنابراین اگه ما اینو نگه داریم قاعدتن میتونیم به این مقدار جدیدی که میخوایم درست کنیم درسترسی داشته باشیم و صرفن میاییم بجای این to  top  که داخل تصویر بالا هست رو میتونیم تغیر بدیم  مثلا   60deg شصد درجه دادیم  و درنهایت اون رو بجای استفاده از اون 8 تا یوتیلیتی یوتیلیتی  که ساختیم برای گرادینت ها gradient60 رو تو کلاس مون قرار میدیم

<div align="center">
  <img  src="./img/bg gradient create new gradient position angle in config file.PNG">
</div>
<div align="center">
  <img  src="./img/bg gradient use gradient coustom config file.PNG">
</div>


هالا مبحث مهم بعدی همونطور که دیدید یوتیلتی های که تلونید برای این قضیه گرادینت داشته صرفن برای گرادینت های خطی که میشه linear-gradient اگه دفت کنین به معادل یوتیلیتی هایی که گزاشته برای این 8 تا یوتیلیتی که برامون گزاشته همشون با linear-gradient هست  و راجب radial -gradient  ها یوتیلیتی یا صحبتی نکرده radial-gradient های دایره ای یعنی گرادینت بصورت دایره ای طور  ولی ما ممکنه به گرادینت های دایره  نیاز داشته باشیم 


<div align="center">
  <img  src="./img/bg gradient create sircle gradient in layer.PNG">
</div>
<div align="center">
  <img  src="./img/bg gradient use create  sircle gradint  layer.PNG">
</div>

ولی خب اگه از این روش استفاده کنیم عملا مجبوریم  که برای هرکدوم از رنگ های گرادینت ها  مثلا اگه چند تا گرادینت با رنگای مختلف برای هرکدوم از اونها باید بیاییم به همین شکل یوتیلتی هاشو بسازیم که زیاد جالب نیست
مامیتونیم بیاییم با استفاده از فیچر های خود تلویند یعنی توفایل کانفیگی تلویند یه radial gradient تعریف کنیم  بجای ساخت یوتیلیتی توی فایل استایل شیت ورودی تلویند


<div align="center">
  <img  src="./img/bg gradient create sircle gradint in config file.PNG">
</div>


دقت کنین که بجای linear-gradient بود برای گرادنت خطی بود
 از radial-gradient  استفاده کردیم که برای  اینجا دیگه قبل متغیر var دیگه جهتی که از کجا باشه رو نمیزاریم چون معلومه که دایره هست و نیاز به جهت دهی نیست و همچنین اون روتو بخش بکگراند گرادنت ها نوشتیم و یه اسم  radialGradient براش گزاشتیم .


<div align="center">
  <img  src="./img/bg gradient use config gradint sercle 1.PNG">
</div>

و درنهایت میتونیم اون رو بصورت یکی ازgradient image هامون استفاده کینم و رنگ شروع و وسط و پاین روبراش بزاریم  این نکنته خیلی مهم بود 
همچنین میتونیم position هاشم بزاریم



<div align="center">
  <img  src="./img/bg gradient use config gradint sercle 2.PNG">
</div>

`همونطور که متوجه شدید ما زمانی که داریم از قضیه گرادینت ها تو تلویند استفاده میکنیم تلویند حد اکثر امکان اضافه کردن سه تا رنگو برای گرادنت های ما داره چرا؟ ` به این علت که مافقط رنگ برای fram , via , to رو داریم درصوتی که ما تو css میتونیم گرادینت هایی داشته باشیم که بیشتر از سه تا باشن چهارتا وبیشتر وگاهی ممکنه که این قضیه نیازمون باشه هالا تو این شرایط باید چیکار کنیم؟  چاره ای نداریم جز بیاییم اون گرادینت ها رو بصورت مطلق  توی فایل  کانفیگ تلویند معرفی شون کنیم  یعنی دیگه از این قضیه متغیره که تلویند  ازطریقش color ها رو ساپورت میکرد همون Gradient Color Stops



<div align="center">
  <img  src="./img/bg gradient show color thow.PNG">
</div>

منضور متغیر رنگ های گرادینت یا Gradient Color Stops اینه  باید بصورت مستقیم کد رنگی مورد نظر خودمون رو داخل این بنویسیم  هلا هم میتونیم برای linear-gradient ها مون این کارو کنیم که گرادینت های خطی هستند هم برای radial-gradient که گرادینت دایره ای طور بود میتوینم بیشتر از سه رنگ بزاریم استفاده کنیم 
هلا من یه مثال برای linear-gradient  میزنیم 


<div align="center">
  <img  src="./img/bg gradient create more three color gradient.PNG">
</div>


هالا دیگه توی فایل html برای این گرادینت newGradient که درست کردیم تو کلاسش نباید از مثلا fram-red-500   یا  avi-blue-600  یا to-red-950 کاری نمیکنه کلا چون ما رنگ ها مون رو تو اون کانفیگ تلویند مون بجای رنگ gradient color stops که تلویند برای گرادینت ها رود بجاش خودمون 4 تا رنگ بهش دادیم اونا روش اعمال میشه.
اینم شد قضیه افزودن بیشتر از سه رنگ به گرادینت تو تلویند.
ولی یه نکته  و تریک این وسط وجود داره اگر که ما بخواییم بجای تایپ کردن این کدهای رنگی که تو فایل کانفیگ تلویند وارد کردیم رو تایپ نکنیم  و از رنگای همین فایل کانفیگ و زنگای تلویند و رنگایی که خودمون تو کانفیگ ممکنه درست کنیم اسفتاده کنیم مثلا میخوایم از red-500 بجای #ff2200 استفاده کینم چیکار کنیم چطوری میتونیم بهش دسترسی داشته باشیم که شاید بعدن اون red-500 رو چند جا استفاده کردم هالا بخوام اوررایتش کنیم و همه اونجا هایی که استفاده کردیم هم تغیر کنن و همینجا هم که میخوایم استفاده کنیم هم تغیر کنه  اینجام تو این newGradient  هم عوض بشه چیکار کنیم ؟ تکنیک کار همینجاست 
اگر که تو داکیومشن تلویند  doc  و بخش Customization   و قمست Theme 
https://tailwindcss.com/docs/theme
بریم  و یه نگاهی بنداریم  میبینیم که ما میتونیم توی فایل کانفیگ تلویند برای مقادیر خودمون هالا چه BackgroundSize باشه چه BackgroundImage  و... باشه بجای اینکه مستقیم مقدار ابجکتی رو درنظر بگیریم یعنی به همون شکل که قبلا عمل میکردیم همون تصویر قبلی  براش یه ابجیکت مینوشتیم  میتونیم بیاییم یه فنکشنی براش درست کنیم  که اون فانکشن  یه ابجکت رو return   کنه که میدونین برای ریترن بیشتر از یک خط کد باید بجای  {} از () استفاده کنیم برای فانکشنمون  و برای پارامتر ورودی این فانکشنمون میتونیم به اون theme  و کل اون کانفیگ های داخل theme دسترسی داشته باشیم  یعنی کل کانفیگ هایی که توی این theme وجود داره و کل مقادیر پیشفرض که داخل این theme وجود دارن توی این theme موجوده بنابراین  ما میتونیم ازش استفاده کنیم  وهالا به هرکدوم از مقادیری که میخوایم دسترسی داشته باشیم 


<div align="center">
  <img  src="./img/bg gradient use color tilwind or coustom color more three color confige file.PNG">
</div>
<div align="center">
  <img  src="./img/bg gradient use color tilwind or coustom color more three color confige file preciwe.PNG">
</div>

---

> # یوتیلیتی جذاب Background Clip برای زمینه عناصر


خیلیی میتونه کارمون رو خوشکل تر کنه  که البته ما با یکی از مقادیرش بیشتر کار میکنیم اما درکل همه مقادیرش رو برسی میکنیم ولی یکی از مقادیرشه که خیلی برای ما احتمالن خیلی نیازمون باشه که ازش استفاده کنیم و درکل یوتیلیتی کاربردی است .
همونظور که میدونین ما تو  css پراپرتی background-clip رو داریم که با هاش میتونیم محدوده برش خوردن و کات خوردن بکگراند مون رو توی عناصر مشخص کنیم  که توی تلویند هم یوتیلیتی های مربوط به این موضوع وجود داره .
وارد داکیومیشن خود تلویند میشیم تو مسیر  Doc  و از منوی   Backgrounds  و Background Clip
...
همونطور که میبنید تلونید 4 تا یوتیلیتی برای background clip ها داره که دیگه قابلیت کانفیگ و مقادیر به روش Arbitrary رو هم نداره چون درکل نیازی به مقدار دیگه ای احساس نمیشه 

bg-clip-border:

<div align="center">
  <img  src="./img/bg clip bg-clip-border.PNG">
</div>

اگه از این یوتیلیتی استفاده کنیم بکگراندی که اعمال میشه کل عنصر و حتی اگه border داشته باشیم زیر اونم پوشش میده و اون border روش قرار میگیره که حالت پیشفرض و دیفالتم همین هست

bg-clip-padding:
<div align="center">
  <img  src="./img/bg clip bg-clip-padding.PNG">
</div>

تو این یوتیلیتی بکگراند ما دیگه زیر border نمیره  و صرفن تا زیر padding ها میاد  و بعد از اون ادامه پیدا نمیکنه 

bg-clip-content:
<div align="center">
  <img  src="./img/bg clip bg-clip-content.PNG">
</div>


در این حالت بکگراند ما فقط زیر اون محتوایی که داخل عنصر هست به اندازه ی اندازه اون قرار میگیره  و دیگه padding ها رو هم پوشش نمیده و فقط تاجایی که content مربوطه به عنصر است رو قرار میده 

bg-clip-text:

<div align="center">
  <img  src="./img/bg clip bg-clip-text.PNG">
</div>

این یوتیلیتی میاد بکگراند شما رو دقیقن مطابق با اون نوشته ای که داخل عنصرتون است برش میزنه . که با این خیلی جذاب و میتونه کار بردی باشه  یعنی میتونین به متن ها توش گرادینت بدین ففقط یه نکته اشاره کنیم  از یوتیلیتی text-transparent هم استفاده کیین که رنگ رو شفاف مثل تصویر کنه 

<div align="center">
  <img  src="./img/bg clip bg-clip-text and code.PNG">
</div>

دقت کنین که اگه این text-transparent رو ننویسید بکگراند یا بکگراند گرادینتمون با اندازه متن عنصر برش میخوره ولی چون خود اون متن رنگ داره بخاطر رنگ متن وجون متن روی بکگراند یا گرادینتمون است قابل دیدن نیست بکگراندمون وقتی از text-transparent استفاده کنیم رنگ متن رو به رنگ اون بکگرانده درمیاره .

---

> # Padding در تلویند

خب دیگه قطعا با  padding تو css آشنا هستین و نیازی به توضیح درمورد کارکرش  و کاربردش نیست ولی میخوایم یوتیلیتی هایی که تلویند برای پدینت ها در اختیارمون قرار داده و اتفاقا خیلی هم کامل وجامع هستند رو باهم برسی کنیم .
داکیومیشن تلویند  رو باز میکنیم Doc و بخش Spacing و Padding 
https://tailwindcss.com/docs/padding


<div align="center">
  <img  src="./img/padding utilites padding.PNG">
</div>


خب همونطور که میبینین تلویند یوتیلیتی های زیادی رو برای قضیه padding دربرامون گزاشته  البته علت تعداد زیاد و تعدد اینا مقادیر و تعداد زیادی رو برامون گزاشته 
`ولی بصورت کلی این یوتیلیتی ها پنج گروه پنج حالت  کلی دارند` و بیشتر از این پنج حالت نیستن 



حالت اول:  حالتیه که مابیاییم عبارت p- و یه عدد رو کنارش بنویسیم مثلا p-0   و یه مقدار عددی بهش بدیم اگه اینطوربنویسیم اون پدینگ با اون مقدار عددی به هر چهار جهت عنصر ما اعمال میشه  که بصورت دیفالت هم همین  p-0 هست که اگه خاستین پدینگی داشت عنصر و خاستین ازش بگیرین میتونیم استفاده کنیم  اگه که خاطرتون باشه قبلا گفتیم  معمولا هر 1واحد که تلویند توی مقادیر عددی خودش افزایش مقدار داره 0.25  صدم  rem  به مقدار نهایی اون توcss اضافه میشه 

این padding  ها تو تلویند قابلیت کانفیگ کردن و Arbitrary  رو دارند که میتونین تو فایل کانفیگ تلویند برا شون مقدار جدیدی هم تعریف کنین 
یه نکته برای اضافه کردن مقادیر جدید برای پدینگ ها  هست اینه که  ما برای تعریف مقادیر جدید برای پدینگ ها تو فایل کانفیک نمینویسیم Padding  و ابجکتشو باز کنیم و توش یه اسم براش درنظر بگیریم و مقدارشو بنویسیم  همینطور هست ولی بجای padding باید از اسم Spacing استفاده کنیم چون تو تلونید این padding  ها و margin ها هم شامل Spasing مشن  و همچنین اگه مثلا من یه مقدار جدید تو فایل کانفیگ توی Spacing اضافه کنم مثلا مقدار 13 رو که تلویند از 12 پریده رو 14 این مقدار 13 که داخل ابجکت Spacing که نوشتم هم برای padding  ها و هم margin ها در دسترس هست  هم هر یوتیلیتی دیگه ای که اگه از Spacing استفاده کنه.

جز p-1  و... یه p-px هم داره استثنا که اون هم برابر 1px است فقط یکی داره هالا برای حالت های مختلف چپ و راست وبالا و پاینن هم فقط یکی p-px داریم که یونیتش برابر  1px است  که برای Spacing ها هست که شامل padding , margin هم میشه که اگه جایی نیاز به یه spacing یه فاصله یک پکسلی نیاز داشتیم میتونیم ازش استفاده  کنیم 

حالت دیگه ای که داریم میتونیم padding رو فقط به راستای عمودی محورX یا افقی محورY بدیم


<div align="center">
  <img  src="./img/padding example py and px.PNG">
</div>

برای این قضیه تلویند برای مثال  py-5   و px-5 رو درنظر گرفته
...
حالت سوم حالیته که padding   هایی هستند که فقط  به یک جهت اعمال میشن مثلا چپ یا راست یا بالا ویا پایین 


<div align="center">
  <img  src="./img/padding example pl,pt,pr,pt,pb.PNG">
</div>

هلا تلویند یه مقدار دیگه هم داره که براساس dir یا دایرکشن صفحه صورت میگیره که گاهی خیلی کاربردیه که ps-px یا pe-px  که برای پیکسل 1px است و هم برای rem  ها هم داریم ps-2  و ps-5 و... که پراپرتی css شونم به شکل پایین هست 
| class      | properties |
| ----------- | ----------- |
...
Inline-start که جهت padding بر اساس جهت dir شروع صفحه اعمال میشه و همجنین linine-end هم از سمت دیگه 
پس میاد padding  رو براساس dir صفحه داکیومنت شما در نظر میگیره مثلا اگه dir="rtl" باشه ps-2 میاد از سمت راست اعمال میشه  و pe-2 هم از سمت چپ   padding رو اعمال میکنه  این pe- و ps-  باتوجه به دایرکشن  داکیومنت صفحه  ما کار میکنه . که خیلی کاربردیه

`
زمانی که دارین سایت های دوزبانه طراحی میکنین  و Dir صفحه عوض میشه  میتونیم از اینا استفاده کنیم حتما و برای margen ها هم همین e , s رو داریم کلا برای spacing ها . که فاصله ها بهم نریزه با تغیر زبان   البته که خود تلویند برای قضیه rtl و ltr  تدبیراتی اندیشیده  که بعدن بهاشون اشنا میشیم.
`

Padding ها از مقادیر Arbitrary پشتیبانی میکنند
...
وتوی فایل کانفیگ تلویند هم میتونیم مقادیر دیگه Spacing رو بنویسیم به این صورت که این مقادیر جدید که مینویسیم هم برای padding ها و هم margin ها در دسترس هستند

<div align="center">
  <img  src="./img/padding confige file coustom.PNG">
</div>
